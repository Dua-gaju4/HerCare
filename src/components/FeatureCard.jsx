const FeatureCard = ({ title, description, icon: Icon, badge }) => {
  return (
    <article className="group rounded-[1.6rem] border border-pink-100 bg-white/80 p-6 shadow-[0_18px_45px_-20px_rgba(233,30,99,0.25)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_-20px_rgba(233,30,99,0.32)]">
      ...
      <h3 className="mt-5 text-xl font-semibold text-[#333333]">{title}</h3>
